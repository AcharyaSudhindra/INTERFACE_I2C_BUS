...
REM
REM Generated by Vivado on Fri Jun 12 23:24:49 +0530 2026
...
echo "xvlog --incr --relax -prj tb_i2c_system_vlog.prj"
call xvlog  --incr --relax -prj tb_i2c_system_vlog.prj -log xvlog.log
